...
import { categorize, isOwnTraffic } from "@mediajel/tracker-widget/recorder/classify";
...
export const beaconSource: Source = ({ widget, emit }) => {
        ...
        emit(
          {
            ...
            resBody: "",
            ms: 0,
            category: categorize(String(url), widget.tag),
