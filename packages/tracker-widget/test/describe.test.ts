...
import { suggestCandidates } from "@mediajel/tracker-widget/ai/suggest";
import { describeEvent, extractFacts, factsLine } from "@mediajel/tracker-widget/recorder/describe";
