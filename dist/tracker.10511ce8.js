...
})({"gQd1h":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "08bb340a10511ce8";
"use strict";
...
},{}],"9Ke0X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _init = require("src/shared/snowplow/v1/init");
const createSnowplowV1Tracker = async (input)=>{
    // We only load the impressions handler if the event is an impression
    const loadImpressionHandler = async ()=>{
        return await require("96c59ac200ba8601").then(({ default: load })=>load());
    };
    const loadEcommerceHandler = async ()=>{
        return await require("842828753fa3f2bf").then(({ default: load })=>load(input));
    };
    return {
        context: input,
...
exports.default = createSnowplowV1Tracker;

},{"src/shared/snowplow/v1/init":"fTa40","96c59ac200ba8601":"81ZUV","842828753fa3f2bf":"5YhZ4","@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}],"fTa40":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}],"81ZUV":[function(require,module,exports) {
module.exports = require("2e9cf2a1ad82edb")(require("c13f873bc0b5c7e2").getBundleURL("KtwVi") + "impressions.e1fdfa41.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("3Jof6"));

},{"2e9cf2a1ad82edb":"kutjI","c13f873bc0b5c7e2":"7CB78"}],"5YhZ4":[function(require,module,exports) {
module.exports = require("5b027c18259b1fd")(require("bdeaa2448012dd83").getBundleURL("KtwVi") + "ecommerce.ccf59055.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("ifPIy"));

},{"5b027c18259b1fd":"kutjI","bdeaa2448012dd83":"7CB78"}]},["gQd1h"], null, "parcelRequire07df")

//# sourceMappingURL=tracker.10511ce8.js.map
