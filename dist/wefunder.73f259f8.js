...
})({"gSqec":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "2871862f73f259f8";
"use strict";
...
},{}],"hgtsN":[function(require,module,exports) {
...
const wefunderTracker = ()=>{
    (0, _xhrResponseSource.xhrResponseSource)((xhr)=>{
        if (xhr.responseURL.includes("investments") && typeof xhr.responseText === "string") try {
...
exports.default = wefunderTracker;

},{"src/shared/utils/create-events-observable":"cy77m","../sources/xhr-response-source":"5fHgU","@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}]},["gSqec"], null, "parcelRequire07df")

//# sourceMappingURL=wefunder.73f259f8.js.map
