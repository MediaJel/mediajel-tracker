...
})({"itjYs":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "fe04d8c668a31fd5";
"use strict";
...
},{}],"bfFWP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const createSnowplowV2TrackerImpressionEventsHandlers = ()=>{
    return {
        /**
     ...
     */ trackLiquidmImpression: ({ advertiserId, advertiserName, insertionOrder, lineItemId, creativeId, publisherId, publisherName, siteId, siteName, liquidmAppId, appName, clickId, GAID, GAID_MD5, GAID_SHA1, IDFA, IDFA_MD5, IDFA_SHA1, DSPIDENTIFIER, DEVICEID, MAXMIND_CON_TYPE_NAME, MAXMIND_GEO_IDS, MAXMIND_ISP_ID })=>{
            const unstruct = {
            ...
            const cCx2 = {
                ...
                data: {
                    campaignOrderId: "Simplifi_campaign_orders"
                }
            };
            const cCx3 = {
        ...
        trackMantisImpression: ({ insertionOrder, creativeId, clickId, publisherId, lineItemId, publisherName })=>{
            const unstruct = {
                schema: "iglu:com.mediajel.events/ad_impression/jsonschema/1-0-3",
                data: {
                    insertionOrder: insertionOrder || "N/A",
            ...
            window.tracker("enableLinkClickTracking", null, false, false, [
                unstruct
            ]); // Do not change the order of the array
        },
        trackSimplifiImpression: ({ advertiserId, advertiserName, insertionOrder, lineItemId, creativeId, publisherId, publisherName, siteId, siteName, liquidmAppId, appName, clickId, GAID, GAID_MD5, GAID_SHA1, IDFA, IDFA_MD5, IDFA_SHA1, DSPIDENTIFIER, DEVICEID, MAXMIND_CON_TYPE_NAME, MAXMIND_GEO_IDS, MAXMIND_ISP_ID })=>{
            const unstruct = {
                schema: "iglu:com.mediajel.events/ad_impression/jsonschema/1-0-3",
                data: {
                    advertiserId: advertiserId || "N/A",
            ...
            const cCx2 = {
                schema: "iglu:com.mediajel.contexts/campaign/jsonschema/1-0-0",
                data: {
                    campaignOrderId: "LiquidM_campaign_orders"
                }
            };
            const cCx3 = {
                schema: "iglu:com.mediajel.contexts/identities/jsonschema/1-0-0",
...
exports.default = createSnowplowV2TrackerImpressionEventsHandlers;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}]},["itjYs"], null, "parcelRequire07df")

//# sourceMappingURL=impressions.68a31fd5.js.map
