...
})({"7xOhT":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "b89e2388d77655eb";
"use strict";
...
},{}],"4D6iX":[function(require,module,exports) {
...
const dutchieSubdomainDataSource = ()=>{
    (0, _googleDatalayerSource.datalayerSource)((data)=>{
        (0, _loggerDefault.default).debug("Dutchie Subdomain Data Source Events: ", {
            data
        });
        ...
        if (data.event === "purchase") {
            (0, _loggerDefault.default).info("Dutchie Transaction Event, Data Source: ", {
                data
            });
...
exports.default = dutchieSubdomainDataSource;

},{"src/shared/logger":"by5yM","src/shared/utils/create-events-observable":"cy77m","../sources/google-datalayer-source":"kqB0w","@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}]},["7xOhT"], null, "parcelRequire07df")

//# sourceMappingURL=dutchie-subdomain.d77655eb.js.map
