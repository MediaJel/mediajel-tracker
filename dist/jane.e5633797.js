...
})({"jfd2T":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "17ffd595e5633797";
"use strict";
...
},{}],"lpV5L":[function(require,module,exports) {
...
var _postMessageSource = require("../sources/post-message-source");
...
const janeDataSource = (snowplow)=>{
    ...
    handler.add("PostMessageSource", ()=>{
        (0, _postMessageSource.postMessageSource)((event)=>{
            ...
            if (payload.name === "checkout") try {
                const { customerEmail, products, cartId, estimatedTotal, deliveryFee, deliveryAddress = {}, salesTax, discountTotal, storeTax } = payload.properties;
                (0, _createEventsObservableDefault.default).notify({
                    transactionEvent: {
    ...
    handler.add("DataLayerSource", ()=>{
        (0, _googleDatalayerSource.datalayerSource)((data)=>{
            ...
            if (event === "ihj_purchase") (0, _createEventsObservableDefault.default).notify({
                transactionEvent: {
...
exports.default = janeDataSource;

},{"src/shared/utils/create-events-observable":"cy77m","../sources/post-message-source":"8lsr9","../sources/google-datalayer-source":"kqB0w","../utils/adapter-handler":"jFrqr","@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}],"8lsr9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "postMessageSource", ()=>postMessageSource);
const postMessageSource = (callback)=>{
...
},{"src/shared/logger":"by5yM","./create-events-observable":"cy77m","@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}]},["jfd2T"], null, "parcelRequire07df")

//# sourceMappingURL=jane.e5633797.js.map
