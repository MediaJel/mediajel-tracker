...
})({"a4TQW":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "c21c1542a6025a1e";
"use strict";
...
},{}],"2aVkI":[function(require,module,exports) {
...
var _tryParseJson = require("../utils/try-parse-json");
// TODO: Maybe remove the success = true; and the if (!success) block
const ecwidTracker = ()=>{
    let success = false;
    try {
        if (!window.transactionOrder && !window.transactionItems) return;
        const transaction = (0, _tryParseJson.tryParseJSONObject)(window.transactionOrder);
        const products = (0, _tryParseJson.tryParseJSONObject)(window.transactionItems);
        ...
        (0, _loggerDefault.default).info("trackError", JSON.stringify(error), "ECWID IMPLEMENTATION 1");
    }
    // In the instance the above code doesn't work, the code below will execute since the if statement is true.
    if (!success) try {
        (0, _pollForElement.pollForElement)([
        ...
        (0, _loggerDefault.default).info("trackError", JSON.stringify(error), "ECWID IMPLEMENTATION 2");
    }
};
exports.default = ecwidTracker;

},{"src/shared/logger":"by5yM","src/shared/utils/create-events-observable":"cy77m","../sources/utils/poll-for-element":"60MG2","../utils/try-parse-json":"gpUsI","@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}],"60MG2":[function(require,module,exports) {
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}],"gpUsI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "tryParseJSONObject", ()=>tryParseJSONObject);
const tryParseJSONObject = (event)=>{
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"6ZdKi"}]},["a4TQW"], null, "parcelRequire07df")

//# sourceMappingURL=ecwid.a6025a1e.js.map
