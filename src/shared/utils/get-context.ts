...
// Locates our tag
const getContext = (): Partial<QueryStringContext> => {
    ...
    const { environment, event, test, appId, mediajelAppId, version, retailId } = Object.fromEntries((urlSearchParams).entries()) as QueryStringParams;
