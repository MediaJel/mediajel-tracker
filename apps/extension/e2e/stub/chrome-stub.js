...
(() => {
  ...
  const SCENARIOS = {
    ...
    "report-1": { step: "home" },
    "report-3": { step: "home", page: "three", activity: { unavailable: [1] } },
    "tally-listening": { step: "home", page: "silent" },
    "tally-no-tags": { step: "home", page: "no-tags" },
    "tally-loading": { step: "home", hang: ["service/tag-activity"] },
    "tally-error": { step: "home", activity: { fail: "error" } },
    "tally-not-configured": { step: "home", activity: { fail: "not-configured" } },
    "tally-4-tags": { step: "home", page: "four" },
    "tally-refreshing": { step: "home", page: "two", activity: { unavailable: [1], hangAfterCalls: 1 } },
    "tally-daily-null": { step: "home", activity: { daily: null } },
    "tally-quiet-week": { step: "home", activity: { quiet: true } },
