...
!(function o(i, c, s) {
...
})(
  {
    ...
    5: [
      ...
      { "./_hashClear": 74, "./_hashDelete": 75, "./_hashGet": 76, "./_hashHas": 77, "./_hashSet": 78 },
    ],
    6: [
      function (e, t, n) {
    ...
    42: [
      ...
      { "./_baseMatches": 45, "./_baseMatchesProperty": 46, "./identity": 126, "./isArray": 128, "./property": 145 },
    ],
    43: [
      function (e, t, n) {
    ...
    118: [
      ...
      { "./_arrayEvery": 17, "./_baseEvery": 26, "./_baseIteratee": 42, "./_isIterateeCall": 80, "./isArray": 128 },
    ],
    119: [
      function (e, t, n) {
        var r = e("./_arrayFilter"),
    ...
    155: [
      function (e, t, n) {
        ...
        function C(e) {
          return (
            !(!Array.isArray(e) || 2 !== e.length) && (Array.isArray(e[1]) ? x(e[0]) && l(e[1], S) : x(e[0]) && S(e[1]))
          );
        }
        function j(e) {
        ...
        n.trackerCore = function (d, o) {
          ...
          return {
            ...
            trackFormFocusOrChange: function (e, t, n, r, a, o, i, c, s) {
              ...
              return (
                "change_form" === e
                  ? ((u = "iglu:com.snowplowanalytics.snowplow/change_form/jsonschema/1-0-0"), (l.type = a))
                  : "focus_form" === e &&
                    ((u = "iglu:com.snowplowanalytics.snowplow/focus_form/jsonschema/1-0-0"), (l.elementType = a)),
              ...
              ("change_form" === a || ("checkbox" !== n && "radio" !== n)) &&
                i.trackFormFocusOrChange(
                  ...
                  (function (e) {
                    for (
                      ;
                      e && e.nodeName && "HTML" !== e.nodeName.toUpperCase() && "FORM" !== e.nodeName.toUpperCase();
    ...
    168: [
      ...
      { "./lib/helpers": 171, "lodash/isFunction": 132, "lodash/isUndefined": 140, "lodash/map": 142 },
    ],
    169: [
      function (e, t, n) {
        var r,
    ...
    170: [
      ...
      { "./helpers": 171, jstimezonedetect: 3, "lodash/isFunction": 132, "lodash/isUndefined": 140 },
    ],
    171: [
      function (e, t, c) {
        !(function () {
        ...
        !(function () {
          ...
          function a(e) {
            ...
            if (
              ...
              try {
                return (
                  (t = document.body.children[0].children[0].children[0].children[0].children[0].children[0].innerHTML),
      ...
      function (e, t, n) {
        ...
        (void 0 !== n ? n : this).getLinkTrackingManager = function (f, r, d) {
          ...
          function u(e, t) {
            for (
              var n, r, a, o, i, c;
              null !== (n = e.parentNode) && !m(n) && "A" !== (r = e.tagName.toUpperCase()) && "AREA" !== r;
            ...
            addClickListeners: function () {
              ...
              for (e = 0; e < n.length; e++)
                a(n[e]) &&
                  ...
                  ((t = n[e]),
                  o
                    ? (v.addEventListener(t, "mouseup", l(i), !1), v.addEventListener(t, "mousedown", l(i), !1))
                ...
                }),
              {
                enqueueRequest: function (e, t) {
                  if (((m = t + c), b)) {
                    ...
                    if (n.bytes >= l)
                      return (
                        T.warn("Event of size " + n.bytes + " is too long - the maximum size is " + l),
                    ...
                    v.push(
                      (function (e) {
                        ...
                        for (var a in e)
                          e.hasOwnProperty(a) &&
                            !n.hasOwnProperty(a) &&
                            (r ? (r = !1) : (t += "&"), (t += encodeURIComponent(a) + "=" + encodeURIComponent(e[a])));
                        for (var o in n)
          ...
          (void 0 !== n ? n : this).Tracker = function (e, t, n, f, r) {
            ...
            var m,
              ...
              ne =
                ...
                (it.warn("argmap.useLocalStorage is deprecated. Use argmap.stateStorageStrategy instead."),
                r.useLocalStorage),
              re =
                !r.hasOwnProperty("useCookies") ||
                (it.warn("argmap.useCookies is deprecated. Use argmap.stateStorageStrategy instead."), r.useCookies),
              ...
              Ae = {};
            for (var xe in (r.hasOwnProperty("discoverRootDomain") && r.discoverRootDomain && (H = it.findRootDomain()),
            ge.gaCookies &&
              ye.push(
                ((k = {}),
            ...
            function Se() {
              (L = ct.fixupUrl(I.domain, E.location.href, it.getReferrer()))[1] !== N && (F = it.getReferrer(N)),
                (M = it.fixupDomain(L[0])),
                (N = L[1]);
            }
            function Ce() {
            ...
            function Be(e, t, n) {
              "localStorage" == ae
                ...
                : ("cookie" != ae && "cookieAndLocalStorage" != ae) || it.cookie(e, t, n, K, H, W, J);
            }
            function Ge() {
              if ("none" == ae) return [];
              var e,
              ...
              if (
                ...
                var n = (function () {
                  ...
                  if (t) {
                    ...
                    return delete n.requestEnd, { schema: "iglu:org.w3/PerformanceTiming/jsonschema/1-0-0", data: n };
                  }
                })();
                n && t.push(n);
              }
              if (E.optimizely) {
                if (ge.optimizelySummary) {
                  var r = ot(
                    ...
                    function (e) {
                      return { schema: "iglu:com.optimizely.snowplow/optimizely_summary/jsonschema/1-0-0", data: e };
                    },
                  );
                  at(r, function (e) {
                    t.push(e);
                          ...
                          for (var n in e)
                            if (e.hasOwnProperty(n)) {
                              ...
                              (r.code = a.code),
                                ...
                                t.push({ schema: "iglu:com.optimizely/experiment/jsonschema/1-0-0", data: r });
                            }
                          return t;
                        }
                        return [];
                ...
                for (var u in ((p = o.getTime()), ke.configurations))
                  if (ke.configurations.hasOwnProperty(u)) {
                    ...
                    clearInterval(l.activityInterval),
                      (l.activityInterval = Qe(_objectSpread({}, l, { configLastActivityTime: p, context: Je(t, n) })));
                  }
            }
            function Qe(e) {
              ...
              return setInterval(function () {
                ...
                p + t > e.getTime() &&
                  r + 1e3 * n < e.getTime() &&
                  (Se(),
                  a({ context: o, pageViewId: Ve(), minXOffset: s, minYOffset: l, maxXOffset: u, maxYOffset: g }),
                  Ne());
              }, t);
            }
            function $e(e, t, n) {
              return e === parseInt(e, 10) && t === parseInt(t, 10)
                ? { configMinimumVisitLength: e, configHeartBeatTimer: 1e3 * t, activityInterval: null, callback: n }
                : (it.warn(
            ...
            function Xe(e) {
              var t = e.context,
                ...
                i = I.title;
              i !== G && ((G = i), (d = null)),
                C.trackPagePing(Oe(v || N), it.fixupTitle(d || G), Oe(m || F), Fe(n), Fe(a), Fe(r), Fe(o), qe(t));
            }
            function Ze(e, t) {
            ...
            Ee(),
              ...
              "none" != ae && (ze(), (x[4] = Math.round(new Date().getTime() / 1e3)), x.shift(), Ue.apply(null, x)),
            ...
            return (
              ...
              (O.enableGdprContext = function (e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null,
                  ...
                  a = S[e];
                a
                  ? ((ge.gdprBasis = !0), (Ae = { gdprBasis: a, gdprDocId: t, gdprDocVer: n, gdprDocDesc: r }))
                  : it.warn(
